...
import com.dg.gym.util.MemberDelete;
import com.dg.gym.util.MemberList;
import com.dg.gym.util.MemberModify;
...
public class Main {
	public static void main(String[] args) {
		...
		while (isNotEnd) {
			System.out.print("명령을 입력하세요 ( 회원정보 : 1 / 회원가입 : 2 / 회원삭제 : 3 / 회원수정 : 4 / 종료하기 : e )");
			String cmd = sc.next();
			switch (cmd) {
			case "1": // 회원정보
			...
			case "3": // 회원삭제
				...
				del.memberDelete(members);
				break;
			case "4": // 회원수정
				MemberModify modify = new MemberModify();
				modify.memberModify(members);
				break;
			case "e": // 종료하기
